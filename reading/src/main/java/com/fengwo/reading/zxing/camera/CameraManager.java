...
package com.fengwo.reading.zxing.camera;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int left = (int) (screenResolution.x * 0.15625);
			int top = (int) (screenResolution.y * 0.175);
			int right = (int) (screenResolution.x * 0.84375);
			int bottom = (int) (screenResolution.y * 0.175) + right - left;
