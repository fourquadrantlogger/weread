 ...
 * 微信朋友圈评论弹窗
 */
public class PopupWindow_copypaste extends BasePopupWindow implements View.OnClickListener {
    ...
    public PopupWindow_copypaste(Context context) {
        this(context, ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    }

    public PopupWindow_copypaste(Context context, int w, int h) {
        super(context, w, h);
    ...
    public void showPopupWindow(View v) {
        try {
            ...
            mPopupWindow.showAtLocation(v, Gravity.RIGHT | Gravity.TOP, (int) (v.getWidth() * 1),
                    viewLocation[1] - ScreenUtil.dip2px(mContext, 15f));
    ...
    public View getPopupView() {
        return LayoutInflater.from(mContext).inflate(R.layout.popup_copy, null);
    }
