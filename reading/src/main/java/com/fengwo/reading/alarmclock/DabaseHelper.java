...
/**
 * @author 继承SQLiteOpenHelper帮助类，通过getReadableDatabase()或
...
public class DabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table alarms("
                ...
                + "minutes INTEGER,label varchar(50),bell varchar(50),repeat varchar(20),"
                + "nextMillis INTEGER,createTime INTEGER, uid varchar(10))");
    }
